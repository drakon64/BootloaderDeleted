...
buildDotnetModule (finalAttrs: {
  pname = "BootloaderDeleted.Webhook";
  ...
  projectFile = "BootloaderDeleted.Webhook.csproj";
  nugetDeps = ./deps.json;

  dotnet-sdk = dotnetCorePackages.sdk_10_0;
  dotnet-runtime = null;

  executables = [ "BootloaderDeleted.Webhook" ];
